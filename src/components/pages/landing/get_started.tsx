...
const GetStarted = () => {
  return (
    <section>
      <div className="max_width flex rounded-[30px] item-start justify-start w-full bg-[#06545B]">
        <div className="my-[58px] mx-[40px] flex-1 flex items-start justify-center flex-col space-y-5" >
          <p className="text-2xl md:text-[34px] font-semibold text-left text-[#F7F9F9]">
            Ready to Store, Send, or Earn?
          </p>

          <p className="md:text-2xl text-sm text-[#C0CBD1] text-left">
          ...
          <Button className="mt-10" >Get Started Now</Button>
        </div>

        <div className="relative flex-1 items-end justify-end">
