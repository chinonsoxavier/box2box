      ...
      <div className="max_width text-center flex items-center justify-center gap-10 flex-col">
        <div className="flex items-center justify-center gap-2.5 flex-col">
          <Animate>
            ...
            <p className="text-sm md:text-[20px] max-w-[907px] text-secondary-foreground">
              Box2Box is more than just storage or delivery — it's a smarter,
              more flexible way to move your life. We connect you to secure
              smart boxes, reliable riders, and trusted vendors across Nigeria —
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(240px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(380px,1fr))] items-center basis-1/3 flex-wrap justify-center w-full gap-5">
          {whychooseus.map((reason, index) => (
              <Animate
                key={index}
                className="flex border rounded-[12px] md:py-[33.7px] py-[30.23px] md:px-[28.1px] px-[25.19px] flex-1 flex-col items-start justify-center md:gap-5 gap-[16.8px] h-full sm:min-h-[330px] bg-[#CBCDCD]/20"
              >
                <img
                  src={reason.image}
